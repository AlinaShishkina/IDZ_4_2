...
double function_fourth_3(double x, std::vector<double> y) {
    ...
    return cosh(1/(x+1)) - log(x*x*x - 2) * y[2] - 2 * x * y[1] - 6*x*x*x*y[0] ;
}
...
void euler() {
    ...
    // Euler. Task 1.
    GnuplotPipe gp1;
    Euler euler_first(7, 100000, 0, {0.7});
    ...
    // Euler. Task 2.
    GnuplotPipe gp2;
    Euler euler_second(6, 100000, 1, {0.2, -0.5});
    ...
    // Euler. Task 3.
    GnuplotPipe gp3;
    Euler euler_third(3, 100000, -1, {-1, -0.5, 1.3});
    ...
    // Euler. Task 4.
    GnuplotPipe gp4;
    Euler euler_fourth(6, 100000, 4.5, {0, 2, 1});
...
void runge_kutta_4() {
    ...
    GnuplotPipe gp1;
    RungeKutta4 euler_first(7, 100000, 0, {0.7});
    euler_first.setFunction({function_first});
    euler_first.printDataInFileFor123({first_file_name});
    gp1.sendLine("plot \"" + first_plot_file_path + first_file_name + R"(" with line title "y1")");
    //*****************************************************
    ...
    GnuplotPipe gp2;
    RungeKutta4 euler_second(6, 100000, 1, {0.2, -0.5});
    euler_second.setFunction({function_second_1, function_second_2});
    euler_second.printDataInFileFor123({second_file_1_name, second_file_2_name});
    gp2.sendLine("plot \"" + first_plot_file_path + second_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + second_file_2_name + R"(" with lines title "y2")");
    ...
    GnuplotPipe gp3;
    RungeKutta4 euler_third(3, 100000, -1, {-1, -0.5, 1.3});
    euler_third.setFunction({function_third_1, function_third_2, function_third_3});
    euler_third.printDataInFileFor123({third_file_1_name, third_file_2_name, third_file_3_name});
    gp3.sendLine("plot \"" + first_plot_file_path + third_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + third_file_2_name + R"(" with lines title "y2", ")"
    ...
    GnuplotPipe gp4;
    RungeKutta4 euler_fourth(6, 100000, 4.5, {0, 2, 1});
    euler_fourth.setFunction({function_fourth_1, function_fourth_2, function_fourth_3});
    euler_fourth.printDataInFileFor4({fourth_file_name});
    gp4.sendLine("plot \"" + first_plot_file_path + fourth_file_name + R"(" with lines title "y1")");
    //*****************************************************
...
void runge_kutta_5() {
    ...
    GnuplotPipe gp1;
    RungeKutta5 euler_first(7, 100000, 0, {0.7});
    euler_first.setFunction({function_first});
    euler_first.printDataInFileFor123({first_file_name});
    gp1.sendLine("plot \"" + first_plot_file_path + first_file_name + R"(" with line title "y1")");
    //*****************************************************
    ...
    GnuplotPipe gp2;
    RungeKutta5 euler_second(6, 100000, 1, {0.2, -0.5});
    euler_second.setFunction({function_second_1, function_second_2});
    euler_second.printDataInFileFor123({second_file_1_name, second_file_2_name});
    gp2.sendLine("plot \"" + first_plot_file_path + second_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + second_file_2_name + R"(" with lines title "y2")");
    ...
    GnuplotPipe gp3;
    RungeKutta5 euler_third(3, 100000, -1, {-1, -0.5, 1.3});
    euler_third.setFunction({function_third_1, function_third_2, function_third_3});
    euler_third.printDataInFileFor123({third_file_1_name, third_file_2_name, third_file_3_name});
    gp3.sendLine("plot \"" + first_plot_file_path + third_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + third_file_2_name + R"(" with lines title "y2", ")"
    ...
    GnuplotPipe gp4;
    RungeKutta5 euler_fourth(6, 100000, 4.5, {0, 2, 1});
    euler_fourth.setFunction({function_fourth_1, function_fourth_2, function_fourth_3});
    euler_fourth.printDataInFileFor4({fourth_file_name});
    gp4.sendLine("plot \"" + first_plot_file_path + fourth_file_name + R"(" with lines title "y1")");
    //*****************************************************
...
void adams_bashfort_4() {
    ...
    GnuplotPipe gp1;
    AdamsBashfort4 euler_first(7, 100000, 0, {0.7});
    euler_first.setFunction({function_first});
    euler_first.printDataInFileFor123({first_file_name});
    gp1.sendLine("plot \"" + first_plot_file_path + first_file_name + R"(" with line title "y1")");
    //*****************************************************
    ...
    GnuplotPipe gp2;
    AdamsBashfort4 euler_second(6, 100000, 1, {0.2, -0.5});
    euler_second.setFunction({function_second_1, function_second_2});
    euler_second.printDataInFileFor123({second_file_1_name, second_file_2_name});
    gp2.sendLine("plot \"" + first_plot_file_path + second_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + second_file_2_name + R"(" with lines title "y2")");
    ...
    GnuplotPipe gp3;
    AdamsBashfort4 euler_third(3, 100000, -1, {-1, -0.5, 1.3});
    euler_third.setFunction({function_third_1, function_third_2, function_third_3});
    euler_third.printDataInFileFor123({third_file_1_name, third_file_2_name, third_file_3_name});
    gp3.sendLine("plot \"" + first_plot_file_path + third_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + third_file_2_name + R"(" with lines title "y2", ")"
    ...
    GnuplotPipe gp4;
    AdamsBashfort4 euler_fourth(6, 100000, 4.5, {0, 2, 1});
    euler_fourth.setFunction({function_fourth_1, function_fourth_2, function_fourth_3});
    euler_fourth.printDataInFileFor4({fourth_file_name});
    gp4.sendLine("plot \"" + first_plot_file_path + fourth_file_name + R"(" with lines title "y1")");
    //*****************************************************
...
void adams_moulton_4() {
    ...
    GnuplotPipe gp1;
    AdamsMoulton4 euler_first(7, 100000, 0, {0.7});
    euler_first.setFunction({function_first});
    euler_first.printDataInFileFor123({first_file_name});
    gp1.sendLine("plot \"" + first_plot_file_path + first_file_name + R"(" with line title "y1")");
    //*****************************************************
    ...
    GnuplotPipe gp2;
    AdamsMoulton4 euler_second(6, 100000, 1, {0.2, -0.5});
    euler_second.setFunction({function_second_1, function_second_2});
    euler_second.printDataInFileFor123({second_file_1_name, second_file_2_name});
    gp2.sendLine("plot \"" + first_plot_file_path + second_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + second_file_2_name + R"(" with lines title "y2")");
    ...
    GnuplotPipe gp3;
    AdamsMoulton4 euler_third(3, 100000, -1, {-1, -0.5, 1.3});
    euler_third.setFunction({function_third_1, function_third_2, function_third_3});
    euler_third.printDataInFileFor123({third_file_1_name, third_file_2_name, third_file_3_name});
    gp3.sendLine("plot \"" + first_plot_file_path + third_file_1_name + R"(" with lines title "y1", ")"
                 + first_plot_file_path + third_file_2_name + R"(" with lines title "y2", ")"
    ...
    GnuplotPipe gp4;
    AdamsMoulton4 euler_fourth(6, 100000, 4.5, {0, 2, 1});
    euler_fourth.setFunction({function_fourth_1, function_fourth_2, function_fourth_3});
    euler_fourth.printDataInFileFor4({fourth_file_name});
    gp4.sendLine("plot \"" + first_plot_file_path + fourth_file_name + R"(" with lines title "y1")");
    //*****************************************************
